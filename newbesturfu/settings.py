...
from mezzanine.project_template.project_name.settings import DATABASES
...
try:
    ...
    if os.environ['EMAIL_USE_SSL']:
        EMAIL_USE_SSL = True
    if os.environ['EMAIL_USE_TLS']:
        EMAIL_USE_TLS = True
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "customApp.context_processors.partners_context_processor",
)
